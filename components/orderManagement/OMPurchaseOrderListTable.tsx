...
import { OMDataTable } from "./shared/OMDataTable";
...
interface OMPurchaseOrderListTableProps {
  ...
  onRowClick?: (po: OMPurchaseOrder) => void;
}

export const OMPurchaseOrderListTable = memo(function OMPurchaseOrderListTable({
  purchaseOrders,
  onDeleteRequest,
  sortBy,
  onSort,
