...
export default function ClientProducts({ products }: { products: Product[] }) {
  ...
  const updateQuantity = (delta: number) => {
    ...
    const newQuantity = Math.max(
      1,
      Math.min(selectedQuantity + delta, selectedProduct.availableStock)
    );
              ...
              <div className="space-y-4">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      {selectedProduct.availableStock} available
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Input
                      ...
                      onChange={(e) => {
                        ...
                        setSelectedQuantity(
                          Math.max(
                            1,
                            Math.min(value, selectedProduct.availableStock)
                          )
                        );
                      }}
                    ...
                    <Button
                      ...
                      onClick={() => updateQuantity(1)}
                      disabled={
                        selectedQuantity >= selectedProduct.availableStock
                      }
                    >
