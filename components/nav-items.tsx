...
export default function NavItems({
  ...
  const { pageAccess, actions, isAdmin } = useFastPermissions();
  ...
  return (
    ...
    >
      ...
      {(() => {
        ...
        const showOMSection = isAdminUser || pageAccess.orders;
        ...
        return (
          ...
          hasAnyManagementAccess && (
            <div className="space-y-1 mt-4">
              ...
              {/* Order Management Collapsed Link */}
              {showOMSection && (
                <Link
                  href="/admin/order-management"
                  className={cn(
