...
export const ResetTokenFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ResetTokenSelect> = z.object({
...
export const ResetTokenFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    identifier: z.boolean().optional(),
    password: z.boolean().optional(),
    token: z.boolean().optional(),
...
export const ResetTokenFindFirstOrThrowSchema: z.ZodType<Prisma.ResetTokenFindFirstOrThrowArgs> = z.object({ select: ResetTokenFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ResetTokenOrderByWithRelationInputObjectSchema, ResetTokenOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResetTokenWhereInputObjectSchema.optional(), cursor: ResetTokenWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResetTokenScalarFieldEnumSchema, ResetTokenScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ResetTokenFindFirstOrThrowArgs>;

export const ResetTokenFindFirstOrThrowZodSchema = z.object({ select: ResetTokenFindFirstOrThrowSelectSchema.optional(),  orderBy: z.union([ResetTokenOrderByWithRelationInputObjectSchema, ResetTokenOrderByWithRelationInputObjectSchema.array()]).optional(), where: ResetTokenWhereInputObjectSchema.optional(), cursor: ResetTokenWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ResetTokenScalarFieldEnumSchema, ResetTokenScalarFieldEnumSchema.array()]).optional() }).strict();