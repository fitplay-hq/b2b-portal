...
export const BundleItemFindFirstSelectSchema: z.ZodType<Prisma.BundleItemSelect> = z.object({
...
export const BundleItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    bundleId: z.boolean().optional(),
    bundle: z.boolean().optional(),
    product: z.boolean().optional(),
...
export const BundleItemFindFirstSchema: z.ZodType<Prisma.BundleItemFindFirstArgs> = z.object({ select: BundleItemFindFirstSelectSchema.optional(), include: z.lazy(() => BundleItemIncludeObjectSchema.optional()), orderBy: z.union([BundleItemOrderByWithRelationInputObjectSchema, BundleItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: BundleItemWhereInputObjectSchema.optional(), cursor: BundleItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BundleItemScalarFieldEnumSchema, BundleItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BundleItemFindFirstArgs>;

export const BundleItemFindFirstZodSchema = z.object({ select: BundleItemFindFirstSelectSchema.optional(), include: z.lazy(() => BundleItemIncludeObjectSchema.optional()), orderBy: z.union([BundleItemOrderByWithRelationInputObjectSchema, BundleItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: BundleItemWhereInputObjectSchema.optional(), cursor: BundleItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BundleItemScalarFieldEnumSchema, BundleItemScalarFieldEnumSchema.array()]).optional() }).strict();