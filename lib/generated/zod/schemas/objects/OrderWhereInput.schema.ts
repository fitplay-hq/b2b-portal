...
import { OrderEmailListRelationFilterObjectSchema as OrderEmailListRelationFilterObjectSchema } from './OrderEmailListRelationFilter.schema';
...
import { BundleListRelationFilterObjectSchema as BundleListRelationFilterObjectSchema } from './BundleListRelationFilter.schema'
...
const orderwhereinputSchema = z.object({
  ...
  emails: z.lazy(() => OrderEmailListRelationFilterObjectSchema).optional(),
  bundleOrderItems: z.lazy(() => BundleOrderItemListRelationFilterObjectSchema).optional(),
  bundles: z.lazy(() => BundleListRelationFilterObjectSchema).optional()
}).strict();
