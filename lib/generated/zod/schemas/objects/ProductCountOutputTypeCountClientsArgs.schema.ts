...
export const ProductCountOutputTypeCountClientsArgsObjectSchema = makeSchema();
export const ProductCountOutputTypeCountClientsArgsObjectZodSchema = makeSchema();
