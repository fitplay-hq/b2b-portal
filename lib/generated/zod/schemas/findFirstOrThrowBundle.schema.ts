...
export const BundleFindFirstOrThrowSelectSchema: z.ZodType<Prisma.BundleSelect> = z.object({
...
export const BundleFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    orderId: z.boolean().optional(),
    order: z.boolean().optional(),
    price: z.boolean().optional(),
...
export const BundleFindFirstOrThrowSchema: z.ZodType<Prisma.BundleFindFirstOrThrowArgs> = z.object({ select: BundleFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BundleIncludeObjectSchema.optional()), orderBy: z.union([BundleOrderByWithRelationInputObjectSchema, BundleOrderByWithRelationInputObjectSchema.array()]).optional(), where: BundleWhereInputObjectSchema.optional(), cursor: BundleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BundleScalarFieldEnumSchema, BundleScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BundleFindFirstOrThrowArgs>;

export const BundleFindFirstOrThrowZodSchema = z.object({ select: BundleFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => BundleIncludeObjectSchema.optional()), orderBy: z.union([BundleOrderByWithRelationInputObjectSchema, BundleOrderByWithRelationInputObjectSchema.array()]).optional(), where: BundleWhereInputObjectSchema.optional(), cursor: BundleWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BundleScalarFieldEnumSchema, BundleScalarFieldEnumSchema.array()]).optional() }).strict();