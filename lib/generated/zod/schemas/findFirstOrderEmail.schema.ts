...
export const OrderEmailFindFirstSelectSchema: z.ZodType<Prisma.OrderEmailSelect> = z.object({
...
export const OrderEmailFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    order: z.boolean().optional(),
    orderId: z.boolean().optional(),
    purpose: z.boolean().optional(),
...
export const OrderEmailFindFirstSchema: z.ZodType<Prisma.OrderEmailFindFirstArgs> = z.object({ select: OrderEmailFindFirstSelectSchema.optional(), include: z.lazy(() => OrderEmailIncludeObjectSchema.optional()), orderBy: z.union([OrderEmailOrderByWithRelationInputObjectSchema, OrderEmailOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrderEmailWhereInputObjectSchema.optional(), cursor: OrderEmailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrderEmailScalarFieldEnumSchema, OrderEmailScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OrderEmailFindFirstArgs>;

export const OrderEmailFindFirstZodSchema = z.object({ select: OrderEmailFindFirstSelectSchema.optional(), include: z.lazy(() => OrderEmailIncludeObjectSchema.optional()), orderBy: z.union([OrderEmailOrderByWithRelationInputObjectSchema, OrderEmailOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrderEmailWhereInputObjectSchema.optional(), cursor: OrderEmailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrderEmailScalarFieldEnumSchema, OrderEmailScalarFieldEnumSchema.array()]).optional() }).strict();