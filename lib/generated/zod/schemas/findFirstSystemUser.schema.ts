...
export const SystemUserFindFirstSelectSchema: z.ZodType<Prisma.SystemUserSelect> = z.object({
...
export const SystemUserFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    password: z.boolean().optional(),
...
export const SystemUserFindFirstSchema: z.ZodType<Prisma.SystemUserFindFirstArgs> = z.object({ select: SystemUserFindFirstSelectSchema.optional(), include: z.lazy(() => SystemUserIncludeObjectSchema.optional()), orderBy: z.union([SystemUserOrderByWithRelationInputObjectSchema, SystemUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: SystemUserWhereInputObjectSchema.optional(), cursor: SystemUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemUserScalarFieldEnumSchema, SystemUserScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SystemUserFindFirstArgs>;

export const SystemUserFindFirstZodSchema = z.object({ select: SystemUserFindFirstSelectSchema.optional(), include: z.lazy(() => SystemUserIncludeObjectSchema.optional()), orderBy: z.union([SystemUserOrderByWithRelationInputObjectSchema, SystemUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: SystemUserWhereInputObjectSchema.optional(), cursor: SystemUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SystemUserScalarFieldEnumSchema, SystemUserScalarFieldEnumSchema.array()]).optional() }).strict();