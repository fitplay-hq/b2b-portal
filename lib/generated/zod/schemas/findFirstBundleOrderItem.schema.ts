...
export const BundleOrderItemFindFirstSelectSchema: z.ZodType<Prisma.BundleOrderItemSelect> = z.object({
...
export const BundleOrderItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    bundleId: z.boolean().optional(),
    bundle: z.boolean().optional(),
    order: z.boolean().optional(),
...
export const BundleOrderItemFindFirstSchema: z.ZodType<Prisma.BundleOrderItemFindFirstArgs> = z.object({ select: BundleOrderItemFindFirstSelectSchema.optional(), include: z.lazy(() => BundleOrderItemIncludeObjectSchema.optional()), orderBy: z.union([BundleOrderItemOrderByWithRelationInputObjectSchema, BundleOrderItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: BundleOrderItemWhereInputObjectSchema.optional(), cursor: BundleOrderItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BundleOrderItemScalarFieldEnumSchema, BundleOrderItemScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.BundleOrderItemFindFirstArgs>;

export const BundleOrderItemFindFirstZodSchema = z.object({ select: BundleOrderItemFindFirstSelectSchema.optional(), include: z.lazy(() => BundleOrderItemIncludeObjectSchema.optional()), orderBy: z.union([BundleOrderItemOrderByWithRelationInputObjectSchema, BundleOrderItemOrderByWithRelationInputObjectSchema.array()]).optional(), where: BundleOrderItemWhereInputObjectSchema.optional(), cursor: BundleOrderItemWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([BundleOrderItemScalarFieldEnumSchema, BundleOrderItemScalarFieldEnumSchema.array()]).optional() }).strict();