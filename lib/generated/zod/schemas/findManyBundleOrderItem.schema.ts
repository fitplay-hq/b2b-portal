...
export const BundleOrderItemFindManySelectSchema: z.ZodType<Prisma.BundleOrderItemSelect> = z.object({
...
export const BundleOrderItemFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    bundleId: z.boolean().optional(),
    bundle: z.boolean().optional(),
    order: z.boolean().optional(),
