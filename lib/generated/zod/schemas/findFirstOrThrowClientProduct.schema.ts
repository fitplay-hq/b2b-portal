...
export const ClientProductFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ClientProductSelect> = z.object({
...
export const ClientProductFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    client: z.boolean().optional(),
    clientId: z.boolean().optional(),
    product: z.boolean().optional(),
...
export const ClientProductFindFirstOrThrowSchema: z.ZodType<Prisma.ClientProductFindFirstOrThrowArgs> = z.object({ select: ClientProductFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ClientProductIncludeObjectSchema.optional()), orderBy: z.union([ClientProductOrderByWithRelationInputObjectSchema, ClientProductOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientProductWhereInputObjectSchema.optional(), cursor: ClientProductWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientProductScalarFieldEnumSchema, ClientProductScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ClientProductFindFirstOrThrowArgs>;

export const ClientProductFindFirstOrThrowZodSchema = z.object({ select: ClientProductFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ClientProductIncludeObjectSchema.optional()), orderBy: z.union([ClientProductOrderByWithRelationInputObjectSchema, ClientProductOrderByWithRelationInputObjectSchema.array()]).optional(), where: ClientProductWhereInputObjectSchema.optional(), cursor: ClientProductWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ClientProductScalarFieldEnumSchema, ClientProductScalarFieldEnumSchema.array()]).optional() }).strict();