...
/**
 * Formats a date string (YYYY-MM-DD or any valid date string) or Date object to a valid ISO-8601 datetime string.
 * This is useful for passing dates to the API which expects a strict datetime format.
 */
 ...
 */
export function isAuthorizedAdminOnly(
  session: { user?: { role?: string } } | null,
): boolean {
...
export function canAccessPage(
  ...
  return (
    hasPermission(userPermissions, resource, PERMISSIONS.VIEW) ||
