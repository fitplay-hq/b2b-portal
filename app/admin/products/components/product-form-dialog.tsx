          ...
          <form
            onSubmit={(e) => {
              ...
              if (
                ...
                toast.error(
                  "Initial stock is required for new products and cannot be negative",
                );
                return;
              }
              ...
              if (
                ...
                Number(formData.minStockThreshold) < 0
              ) {
              ...
              <div className="space-y-4">
                ...
                {formData.image && (
                  <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-md border">
                    <div className="w-20 h-20 shrink-0 rounded-md overflow-hidden border border-gray-200 bg-white">
                      <img
                        src={formData.image}
