...
import { Calendar, Loader2, Package, Plus, Search, X, ArrowLeft } from "lucide-react";
    ...
    <Layout title="Create Dispatch Order" isClient={false}>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Fill order details and pick products</p>
        </div>
        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="space-y-2">
                ...
                <Textarea rows={4} value={deliveryAddress} onChange={(e) => setDeliveryAddress(e.target.value)} />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              ...
              <Input value={deliveryReference} onChange={(e) => setDeliveryReference(e.target.value)} placeholder="Any order reference for future use" />
        ...
        <div className="xl:col-span-2 space-y-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div>
                <Label className="text-sm font-medium mb-2 block">Selected Products ({selectedProducts.length})</Label>
                {selectedProducts.length === 0 ? (
                  <div className="border rounded-md p-8 text-center">
                    <p className="text-sm text-muted-foreground">Search and select products to add them to this order</p>
                  </div>
                ) : (
