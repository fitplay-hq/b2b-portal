...
export async function POST(req: NextRequest) {
    try {
        ...
        if (!name || !email || !password || !phone || !companyName || !address) {
        ...
        return NextResponse.json(
            { error: error.message || "Something went wrong couldn't add client" },
            { status: 500 },
        );
    }
}
...
export async function GET(req: NextRequest) {
    try {
        ...
        return NextResponse.json(
            { error: error.message || "Something went wrong couldn't fetch client" },
            { status: 500 },
        );
    }
}
...
export async function DELETE(req: NextRequest) {
    try {
        ...
        return NextResponse.json(
            { error: error.message || "Something went wrong couldn't delete client" },
            { status: 500 },
        );
    }
}
...
export async function PATCH(req: NextRequest) {
    try {
        ...
        return NextResponse.json(
            { error: error.message || "Something went wrong couldn't update client" },
            { status: 500 },
        );
    }
}
